                    ...
                    <CardBox hasTable isList className={'rounded shadow-none'}>
                        <div className={`flex rounded dark:bg-dark-900 border items-center overflow-hidden`}>
                          ...
                          >
                            ...
                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs text-gray-500'}>ProductionManager</p>
                                <p className={'line-clamp-2'}>{ dataFormatter.usersOneListFormatter(item.production_manager) }</p>
                            </div>
                            ...
                            <div className={'flex-1 px-3'}>
                                ...
                                <p className={'line-clamp-2'}>{ item.machines }</p>
                            </div>
