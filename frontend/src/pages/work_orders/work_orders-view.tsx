          ...
          <SectionMain>
            ...
            <CardBox>
                ...
                <FormField label='StartDate'>
                    {work_orders.start_date ? <DatePicker
                      dateFormat="yyyy-MM-dd hh:mm"
                      showTimeSelect
                      selected={work_orders.start_date ?
                        new Date(
                          dayjs(work_orders.start_date).format('YYYY-MM-DD hh:mm'),
                        ) : null
                      }
                      disabled
                    /> : <p>No StartDate</p>}
                ...
                <FormField label='EndDate'>
                    {work_orders.end_date ? <DatePicker
                      dateFormat="yyyy-MM-dd hh:mm"
                      showTimeSelect
                      selected={work_orders.end_date ?
                        new Date(
                            ...
                            {work_orders.quality_control_work_order && Array.isArray(work_orders.quality_control_work_order) &&
                              work_orders.quality_control_work_order.map((item: any) => (
                                <tr key={item.id} onClick={() => router.push(`/quality_control/quality_control-view/?id=${item.id}`)}>
                                    ...
                                    <td data-label="inspection_stage">
                                        { item.inspection_stage }
                                    </td>
