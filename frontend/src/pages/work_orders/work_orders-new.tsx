...
const Work_ordersNew = () => {
  ...
  <FormField label="ProductionManager" labelFor="production_manager">
      <Field name="production_manager" id="production_manager" component={SelectField} options={[]} itemRef={'users'}></Field>
  </FormField>
