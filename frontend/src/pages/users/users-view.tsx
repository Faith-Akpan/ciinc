      ...
      <>
          ...
          <SectionMain>
            ...
            <CardBox>
                ...
                <>
                    <p className={'block font-bold mb-2'}>Work_orders ProductionManager</p>
                    <CardBox
                    ...
                    >
                        <div className='overflow-x-auto'>
                            ...
                            <tbody>
                            {users.work_orders_production_manager && Array.isArray(users.work_orders_production_manager) &&
                              users.work_orders_production_manager.map((item: any) => (
                                <tr key={item.id} onClick={() => router.push(`/work_orders/work_orders-view/?id=${item.id}`)}>
                        ...
                        {!users?.work_orders_production_manager?.length && <div className={'text-center py-4'}>No data</div>}
                    </CardBox>
                </>
